				...
				<div class="row my-2">
					...
					<div class="form-group col-md-6">
						...
						<select id="propietario" class="form-control" name="persona_id">
							<option <?=get_select('persona_id', $row->propietario->persona_id)?> value="<?=$row->propietario->persona_id?>"><?=ucwords($row->propietario->nombre)?> <?=ucwords($row->propietario->apellido_1)?> </option>
